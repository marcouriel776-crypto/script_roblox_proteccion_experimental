...
ScriptRunning = true
ProtectionEnabled = Settings and Settings.protection_enabled or false
ProtectionManualOverride = (ProtectionManualOverride == nil) and (Settings and Settings.protection_manual_override) or ProtectionManualOverride
...
MainGradient.Color = ColorSequence.new{ ColorSequenceKeypoint.new(0, Color3.fromRGB(28,32,48)), ColorSequenceKeypoint.new(1, Color3.fromRGB(18,20,30)) }
...
local HeaderGradient = Instance.new("UIGradient"); HeaderGradient.Parent = Header
HeaderGradient.Color = ColorSequence.new{ ColorSequenceKeypoint.new(0, Color3.fromRGB(45,60,120)), ColorSequenceKeypoint.new(1, Color3.fromRGB(30,40,90)) }
